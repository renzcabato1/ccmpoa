...
function toggleTheme() {
    ...
    console.log(t),
        null != t && null != t && (setThemeToLocalStorage(t), "dark" === t && $(".theme-toggle input").prop("checked", !0), $(document).trigger("themeChange", t)),
        $(".theme-toggle input").on("change", function () {
            !0 === $(this).prop("checked")
                ? (console.log("checked"), setThemeToLocalStorage("dark"), $(".theme-toggle input").prop("checked", !0), $(document).trigger("themeChange", "dark"))
                : (setThemeToLocalStorage("light"), $(".theme-toggle input").prop("checked", !1), $(document).trigger("themeChange", "light"));
        });
}
function linkCheck() {
    $(".dashboard-aside-link").length &&
...
function initNavbarCart() {
    $(".is-cart .cart-button").on("click", function () {
        ...
        $(document).click(function (t) {
            var o = t.target;
            $(o).is(".is-cart .cart-button") ||
                $(o).parents().is(".is-cart") ||
...
function initPostComments() {
    $(".fab-wrapper.is-comment, .close-comments").on("click", function (t) {
        ...
        console.log(i),
            $("html, body")
                .stop()
                .animate({ scrollTop: i.top - 70 }, 500),
            t.preventDefault(),
            setTimeout(function () {
...
function initSimplePopover() {
    $(".has-tip").webuiPopover({ trigger: "hover", placement: "auto", width: 300, padding: !1, offsetLeft: 0, offsetTop: 0, animation: "pop", cache: !1 });
}
        ...
        var t = "",
            ...
            i = {
                ...
                template: {
                    ...
                    method: function (t, o) {
                        return (
                            "<div class=template-wrapper><div class=avatar-wrapper><img class=autocpl-avatar src='" +
                            o.pic +
        ...
        $(".combo-box .box-dropdown li").on("click", function (t) {
            ...
            console.log(s),
                ...
                e.length
                    ...
                    : ($(this).closest(".combo-box").find(".combo-item i").remove(), $(this).closest(".combo-box").find(".combo-item").prepend(s), $(this).closest(".combo-box").find(".combo-item .selected-item").text(a));
        }),
        $(document).click(function (t) {
            var o = t.target;
    ...
    $(".is-combo .stacked-combo-box").on("click", function () {
        ...
        $(".stacked-combo-box .box-dropdown li").on("click", function (t) {
            ...
            $(o).is(".box-dropdown li, body") || $(o).parents().is(".box-dropdown") || $(".box-dropdown").removeClass("is-active"),
                ...
                $(this).toggleClass("is-active"),
                console.log(s),
                0 == $(".stacked-combo-box li.is-active").length
                    ? ($("#" + e).remove(), $("#skill-placeholder").removeClass("is-hidden"), $(this).closest(".stacked-combo-box").find(".selected-item").text("Select one or more skills"))
        ...
        $(".textFilter-input")
            ...
            .keyup(function (t) {
                ...
                if (
                    ...
                    console.log(i),
                        0 == i
                            ? ($(".card-row-wrap.is-active").find(".card-row").addClass("is-hidden"), $(".card-row-wrap.is-active").find(".card-row-placeholder").removeClass("is-hidden"))
                            : ($(".card-row-wrap.is-active").find(".card-row-placeholder").addClass("is-hidden"), $(".card-row-wrap.is-active").find(".card-row").removeClass("is-hidden"));
                }
            });
}
    ...
    $(".about-glider").each(function () {
        if ($(this).is(":visible")) {
            ...
            new Glider(document.querySelector("#" + t), {
                ...
                draggable: !0,
                responsive: [
                    { breakpoint: 768, settings: { slidesToShow: 3, slidesToScroll: 3, itemWidth: 150, duration: 0.25 } },
                    { breakpoint: 300, settings: { slidesToShow: 1, slidesToScroll: 1, duration: 0.25 } },
                ],
            });
        }
    });
