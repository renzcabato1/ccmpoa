...
$(document).ready(function () {
    ...
    initAutoTag(),
        ...
        $("#story-upload").length &&
            document.getElementById("story-upload").addEventListener("change", function (e) {
                var i = e.target.files[0],
                    a = new FileReader();
                i.type.match("image")
                    ? (toasts.service.info("", "mdi mdi-video", "Please upload a video file", "bottomRight", 2500), (document.getElementById("story-upload").value = null))
                    : ((a.onload = function () {
                          var e = new Blob([a.result], { type: i.type }),
        ...
        $("#story-image-upload").length &&
            document.getElementById("image-story-upload").addEventListener("change", function (e) {
                var i = e.target.files[0],
                    a = new FileReader();
                i.type.match("image")
                    ? ((a.onload = function () {
                      ...
                      a.readAsDataURL(i))
                    : (toasts.service.info("", "mdi mdi-image-outline", "Please upload an image", "bottomRight", 2500), (document.getElementById("image-story-upload").value = null));
