    ...
    if (e.files && e.files[0]) {
        ...
        (i.onload = function (e) {
            ...
            $("#feed-upload").append(t),
                $("#feed-upload-input-1, #feed-upload-input-2").css("display", "none"),
                $(".remove-file").on("click", function () {
                    $("#feed-upload-input-1, #feed-upload-input-2").val("").css("display", "block"), $(this).closest(".upload-wrap").remove();
                });
        }),
...
$("#compose-card").length &&
    ...
    $("#publish").on("input", function () {
        $(this).val().length >= 1 ? $("#publish-button").removeClass("is-disabled") : $("#publish-button").addClass("is-hidd");
    }),
    ...
    $("#album-datepicker").datepicker({ format: "mm-dd-yyyy", container: "body", autoHide: !0, offset: 0 }),
    videosHelp());
