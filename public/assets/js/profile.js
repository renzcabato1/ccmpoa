...
/*! profile.js | Friendkit | © Css Ninja. 2019-2020 */ $(document).ready(function () {
    if ($(".profile-menu").length) {
        ...
        "" == (e = (e = (e = e.substring(0, -1 == e.indexOf("#") ? e.length : e.indexOf("#"))).substring(0, -1 == e.indexOf("?") ? e.length : e.indexOf("?"))).substr(e.lastIndexOf("/") + 1)) && (e = "index.html"),
                    ...
                    ? $(this).hasClass("is-shifted")
                        ? ($(this).removeClass("is-shifted"),
                          iziToast.show({
                              ...
                              title: "",
                              message: "You are not following "+name+" anymore",
                              titleColor: "#fff",
                              messageColor: "#fff",
                              iconColor: "#fff",
        ...
        $("#upload-cover-picture").on("change", function () {
            ...
            $("#submit-cover-picture").on("click", function (e) {
                $(this).addClass("is-loading"),
                    i.croppie("result", { type: "canvas", size: "original" }).then(function (e) {
                        var i, o;
                            (i = { src: e }).html && ((o = i.html), console.log("HTML RESULT", o)),
                            i.src && ((o = '<img src="' + i.src + '" />'), $(".cover-image").attr("src", i.src), $("#submit-cover-picture").removeClass("is-loading"), $("#upload-crop-cover-modal").removeClass("is-active"));
                    });
    ...
    if ($("#upload-profile").length) {
        ...
        $("#upload-profile-picture").on("change", function () {
            ...
            $("#submit-profile-picture").on("click", function (e) {
                $(this).addClass("is-loading"),
                    o.croppie("result", { type: "canvas", size: "viewport" }).then(function (e) {
                        var i;
                        (i = { src: e }).html && i.html,
                            i.src && (i.src, $(".cover-bg .avatar .avatar-image, #user-avatar-minimal").attr("src", i.src), $("#submit-profile-picture").removeClass("is-loading"), $("#upload-crop-profile-modal").removeClass("is-active"));
                    });
    ...
    $(".close-nested-photos").on("click", function () {
        ...
        $("#profile-about").length &&
            ($(".left-menu .menu-item").on("click", function () {
                ...
                $(".left-menu .menu-item").removeClass("is-active"),
                    ...
                    ("education-content" != e && "job-content" != e) || initAboutGlider();
            }),
        ...
        $("#profile-photos, #pages-photos").length &&
            ...
            $(".image-grid .image-row > div .overlay").on("click", function () {
                var e = $(this),
                    i = e.closest(".image-row > div").attr("data-background"),
                    o = e.siblings(".image-owner").find("img").attr("src"),
                    s = e.siblings(".image-owner").find(".name").text(),
