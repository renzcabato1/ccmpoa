        ...
        <div class="container is-custom">
            ...
            <div id="profile-main" class="view-wrap is-headless">
               @include('profiles.profile_header')
                 ...
                 <div class="columns profile-photos" id="photos">
                    <div class="column">
                          ...
                          <div class="image-row">
                                <!--Photo-->
                                    @foreach ($allPhotos as $allPhoto )
                                        @foreach ($allPhoto->coverPhoto as $key => $cover)

                                            <div class="flex-2 has-background-image"
                                                data-background="{{ asset($cover->image) }}"
                                                data-demo-background="{{ asset($cover->image) }}" onerror="this.src='{{ URL::asset('https://via.placeholder.com/1600x900') }}';">
                                                ...
                                                <div class="image-owner">
                                                    ...
                                                    <div class="name">{{ $cover->user->name }}</div>
                                                </div>
                                                <div class="photo-time">{{ date('M. d, Y', strtotime($cover->created_at)) }}</div>
                                                <a class="photo-like is-hidden">
                                                    <div class="inner">
                                            ...
                                            @endif
                                        @endforeach
                                        @foreach ($allPhoto->userAvatar as $key => $avatar)
                                            <div class="flex-2 has-background-image"
                                            data-background="{{ asset($avatar->avatar) }}"
                                            data-demo-background="{{ asset($avatar->avatar) }}" onerror="this.src='{{ URL::asset('https://via.placeholder.com/1600x900') }}';">
                                            <div class="overlay"></div>
                                            <div class="image-owner">
                                                <img class="avatar" src="https://via.placeholder.com/150x150"
                                                    data-demo-src="assets/img/avatars/jenna.png" alt="">
                                                <div class="name">{{ $avatar->user->name }}</div>
                                            </div>
                                            <div class="photo-time">{{ date('M. d, Y', strtotime($avatar->created_at)) }}</div>
                                            <a class="photo-like is-hidden">
                                                <div class="inner">
                                                    <div class="like-overlay"></div>
                                                    <i data-feather="heart"></i>
                                            ...
                                            @endif
                                        @endforeach
                                        @foreach ($allPhoto->attachments as $key => $post)
                                            <div class="flex-2 has-background-image"
                                            data-background="{{ asset($post->attachment) }}"
                                            data-demo-background="{{ asset($post->attachment) }}" onerror="this.src='{{ URL::asset('https://via.placeholder.com/1600x900') }}';">
                                            <div class="overlay"></div>
                                            <div class="image-owner">
                                                <img class="avatar" src="https://via.placeholder.com/150x150"
                                                    data-demo-src="assets/img/avatars/jenna.png" alt="">
                                                <div class="name">{{ $allPhoto->name }}</div>
                                            </div>
                                            <div class="photo-time">{{ date('M. d, Y', strtotime($post->created_at)) }}</div>
                                            <a class="photo-like is-hidden">
                                                <div class="inner">
                                                    <div class="like-overlay"></div>
                                                    <i data-feather="heart"></i>
...
<script>
    ...
    function activatePhotos(){
        ...
        profileMain.classList.add("is-hidden");
        let profilePhotos = document.querySelector('.profile-photos');
        profilePhotos.classList.remove("is-hidden");
